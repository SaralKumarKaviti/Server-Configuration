...
You can visit http://54.80.229.182/ or http://ec2-54-80-229-182.compute-1.amazonaws.com/ for the website deployed.
...
### Step 1: Start a new Ubuntu Linux server instance on Amazon EC2 
  ...
  - we can download a .pem file and connect with following command
    ```
    ssh -i cricket_player_catalog.pem ubuntu@54.80.229.182
    ``` 
...
- To check port 2200 wether working or not by `ssh -i cricket_player_catalog.pem -p 2200 ubuntu@54.80.229.182` 
...
### Step: grader connection

- Now open with another git bash and connect with grader `ssh -i cricket_player_catalog.pem -p 2200 grader@54.80.229.182`
...
### Step 7: Create an SSH key pair for `grader`
  ...
  - Restart SSH: `sudo service ssh restart`
  - On the local machine, cheking if the grader account working or not by running this command : `ssh -i cricket_player_catalog.pem -p 2200 grader@54.80.229.182`.
...
`sudo git clone https://github.com/SaralKumarKaviti/catalog.git`.
...
- Click `Credentials`.
- Create an OAuth Client ID (under the Credentials tab), and add http://54.80.229.182.xip.io and 
http://ec2-54-80-229-182.compute-1.amazonaws.com/ as authorized JavaScript 
origins.
- Add http://54.80.229.182.xip.io/login,http://54.80.229.182.xip.io/gconnect,http://54.80.229.182.xip.io/callback
...
### Step 13.2: Set up and enable a virtual host
  ...
  ```
  <VirtualHost *:80>
      ServerName 54.80.229.182.xip.io
      ServerAlias ec2-54-80-229-182.compute-1.amazonaws.com
      ServerAdmin ubuntu@54.80.229.182
...
- Run: `python cricket_database.py`.
...
- Open your browser to http://54.80.229.182/country
